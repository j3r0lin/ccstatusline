...
interface UsagePercentWidgetSuiteConfig<TWidget extends UsageWidgetLike> {
    ...
    usageField: 'sessionUsage' | 'weeklyUsage' | 'weeklySonnetUsage' | 'weeklyOpusUsage' | 'monthlyUsage' | 'fableUsage';
    usageValue: number;
}
...
function getUsageContext(field: 'sessionUsage' | 'weeklyUsage' | 'weeklySonnetUsage' | 'weeklyOpusUsage' | 'monthlyUsage' | 'fableUsage', value: number): RenderContext {

...
interface UsagePercentWidgetSuiteConfig<TWidget extends UsageWidgetLike> {
    ...
    usageField: 'sessionUsage' | 'weeklyUsage' | 'weeklySonnetUsage' | 'weeklyOpusUsage' | 'monthlyUsage';
    usageValue: number;
}
...
function getUsageContext(field: 'sessionUsage' | 'weeklyUsage' | 'weeklySonnetUsage' | 'weeklyOpusUsage' | 'monthlyUsage', value: number): RenderContext {
